...
import { Plus, Search, Trash2, Mail, Shield, UserCircle } from "lucide-react";
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    <button 
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-rose-600 bg-rose-50 hover:bg-rose-100 hover:text-rose-700 rounded-xl transition-all cursor-pointer ring-1 ring-inset ring-rose-200"
